<!doctype html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/css2/bootstrap-theme.min.css">
        <link rel="stylesheet" href="assets/css2/onepage.css">

        <script src="assets/js2/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
    <body>
        [if lt IE 8]>
        ...
        <script>window.jQuery || document.write('<script src="assets/js2/vendor/jquery-1.11.2.min.js"><\/script>')</script>

        <script src="assets/js2/vendor/bootstrap.min.js"></script>

        <script src="assets/js2/plugins.js"></script>
